...
export const IdentityApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary List an Identity\'s trusted devices
         * @param {string} id ID is the identity\&#39;s ID.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listIdentityDevices: async (id: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('listIdentityDevices', 'id', id)
            const localVarPath = `/admin/identities/{id}/devices`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @summary Patch an Identity\'s devices
         * @param {string} id ID is the session\&#39;s ID.
         * @param {string} deviceId DeviceID is the Identity\&#39;s Device\&#39;s ID.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchIdentityDevices: async (id: string, deviceId: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('patchIdentityDevices', 'id', id)
            // verify required parameter 'deviceId' is not null or undefined
            assertParamExists('patchIdentityDevices', 'deviceId', deviceId)
            const localVarPath = `/admin/identities/{id}/devices/{device_id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)))
...
export const IdentityApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listIdentityDevices(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<SessionDevice>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listIdentityDevices(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['IdentityApi.listIdentityDevices']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Returns a list of all identity schemas currently in use.
         ...
         * @throws {RequiredError}
         */
        async patchIdentityDevices(id: string, deviceId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<SessionDevice>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchIdentityDevices(id, deviceId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['IdentityApi.patchIdentityDevices']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * This endpoint updates an [identity](https://www.ory.sh/docs/kratos/concepts/identity-user-model). The full identity payload (except credentials) is expected. It is possible to update the identity\'s credentials as well.
...
export const IdentityApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * This endpoint returns all trusted devices for any sessions that belong to the given Identity.
         * @summary List an Identity\'s trusted devices
         * @param {IdentityApiListIdentityDevicesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listIdentityDevices(requestParameters: IdentityApiListIdentityDevicesRequest, options?: RawAxiosRequestConfig): AxiosPromise<Array<SessionDevice>> {
            return localVarFp.listIdentityDevices(requestParameters.id, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a list of all identity schemas currently in use.
         * @summary Get all Identity Schemas
         ...
         * Partially updates an identity\'s device\'s trusted field using [JSON Patch](https://jsonpatch.com/). Only the field `trusted` can be updated using this method. Even that can only be set to `false` using this method.
         * @summary Patch an Identity\'s devices
         * @param {IdentityApiPatchIdentityDevicesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchIdentityDevices(requestParameters: IdentityApiPatchIdentityDevicesRequest, options?: RawAxiosRequestConfig): AxiosPromise<Array<SessionDevice>> {
            return localVarFp.patchIdentityDevices(requestParameters.id, requestParameters.deviceId, options).then((request) => request(axios, basePath));
        },
        /**
         * This endpoint updates an [identity](https://www.ory.sh/docs/kratos/concepts/identity-user-model). The full identity payload (except credentials) is expected. It is possible to update the identity\'s credentials as well.
         * @summary Update an Identity
...
/**
 * Request parameters for listIdentityDevices operation in IdentityApi.
 * @export
 * @interface IdentityApiListIdentityDevicesRequest
 */
export interface IdentityApiListIdentityDevicesRequest {
    /**
     * ID is the identity\&#39;s ID.
     * @type {string}
     * @memberof IdentityApiListIdentityDevices
     */
    readonly id: string
}
...
/**
 * Request parameters for patchIdentityDevices operation in IdentityApi.
 * @export
 * @interface IdentityApiPatchIdentityDevicesRequest
 */
export interface IdentityApiPatchIdentityDevicesRequest {
    /**
     * ID is the session\&#39;s ID.
     * @type {string}
     * @memberof IdentityApiPatchIdentityDevices
     */
    readonly id: string
...
export class IdentityApi extends BaseAPI {
     ...
     * @memberof IdentityApi
     */
    public listIdentityDevices(requestParameters: IdentityApiListIdentityDevicesRequest, options?: RawAxiosRequestConfig) {
        return IdentityApiFp(this.configuration).listIdentityDevices(requestParameters.id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof IdentityApi
     */
    public patchIdentityDevices(requestParameters: IdentityApiPatchIdentityDevicesRequest, options?: RawAxiosRequestConfig) {
        return IdentityApiFp(this.configuration).patchIdentityDevices(requestParameters.id, requestParameters.deviceId, options).then((request) => request(this.axios, this.basePath));
    }
