...
export interface ListIdentityDevicesRequest {
    id: string;
}
...
export interface PatchIdentityDevicesRequest {
    id: string;
    deviceId: string;
}
...
export class IdentityApi extends runtime.BaseAPI {
     ...
     */
    async listIdentityDevicesRaw(requestParameters: ListIdentityDevicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SessionDevice>>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling listIdentityDevices().'
            );
        }
        ...
        const response = await this.request({
            path: `/admin/identities/{id}/devices`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(SessionDeviceFromJSON));
    }
     ...
     * List an Identity\'s trusted devices
     */
    async listIdentityDevices(requestParameters: ListIdentityDevicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SessionDevice>> {
        const response = await this.listIdentityDevicesRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async patchIdentityDevicesRaw(requestParameters: PatchIdentityDevicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SessionDevice>>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling patchIdentityDevices().'
            );
        }
        ...
        if (requestParameters['deviceId'] == null) {
            throw new runtime.RequiredError(
                'deviceId',
                'Required parameter "deviceId" was null or undefined when calling patchIdentityDevices().'
            );
        }
        ...
        const response = await this.request({
            path: `/admin/identities/{id}/devices/{device_id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))).replace(`{${"device_id"}}`, encodeURIComponent(String(requestParameters['deviceId']))),
            method: 'PATCH',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Patch an Identity\'s devices
     */
    async patchIdentityDevices(requestParameters: PatchIdentityDevicesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SessionDevice>> {
        const response = await this.patchIdentityDevicesRaw(requestParameters, initOverrides);
        return await response.value();
    }
