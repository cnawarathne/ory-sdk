...
class IdentityApi:
    ...
    def list_identity_devices(
        ...
        _param = self._list_identity_devices_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_identity_devices_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the identity's ID.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SessionDevice]]:
        """List an Identity's trusted devices
    ...
    @validate_call
    def list_identity_devices_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the identity's ID.")],
        _request_timeout: Union[
            None,
    ...
    def _list_identity_devices_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/admin/identities/{id}/devices',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_identity_devices(
        self,
        id: Annotated[StrictStr, Field(description="ID is the session's ID.")],
        device_id: Annotated[StrictStr, Field(description="DeviceID is the Identity's Device's ID.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID is the session's ID. (required)
        :type id: str
        :param device_id: DeviceID is the Identity's Device's ID. (required)
        :type device_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._patch_identity_devices_serialize(
            id=id,
            device_id=device_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def patch_identity_devices_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID is the session's ID.")],
        device_id: Annotated[StrictStr, Field(description="DeviceID is the Identity's Device's ID.")],
        _request_timeout: Union[
    ...
    @validate_call
    def patch_identity_devices_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID is the session's ID.")],
        device_id: Annotated[StrictStr, Field(description="DeviceID is the Identity's Device's ID.")],
        _request_timeout: Union[
    ...
    def _patch_identity_devices_serialize(
        self,
        id,
        device_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/admin/identities/{id}/devices/{device_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
