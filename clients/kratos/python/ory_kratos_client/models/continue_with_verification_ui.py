...
class ContinueWithVerificationUi(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr = Field(description="Action will always be `show_verification_ui` show_verification_ui ContinueWithActionShowVerificationUIString")
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['show_verification_ui']):
            raise ValueError("must be one of enum values ('show_verification_ui')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flow": ContinueWithVerificationUiFlow.from_dict(obj["flow"]) if obj.get("flow") is not None else None
        })
