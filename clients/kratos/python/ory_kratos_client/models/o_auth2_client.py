...
class OAuth2Client(BaseModel):
    ...
    authorization_code_grant_access_token_lifespan: Optional[StrictStr] = Field(default=None, description="Specify a time duration in milliseconds, seconds, minutes, hours.")
    authorization_code_grant_id_token_lifespan: Optional[StrictStr] = Field(default=None, description="Specify a time duration in milliseconds, seconds, minutes, hours.")
    authorization_code_grant_refresh_token_lifespan: Optional[StrictStr] = Field(default=None, description="Specify a time duration in milliseconds, seconds, minutes, hours.")
    ...
    client_credentials_grant_access_token_lifespan: Optional[StrictStr] = Field(default=None, description="Specify a time duration in milliseconds, seconds, minutes, hours.")
    ...
    implicit_grant_access_token_lifespan: Optional[StrictStr] = Field(default=None, description="Specify a time duration in milliseconds, seconds, minutes, hours.")
    implicit_grant_id_token_lifespan: Optional[StrictStr] = Field(default=None, description="Specify a time duration in milliseconds, seconds, minutes, hours.")
    ...
    jwt_bearer_grant_access_token_lifespan: Optional[StrictStr] = Field(default=None, description="Specify a time duration in milliseconds, seconds, minutes, hours.")
    ...
    refresh_token_grant_access_token_lifespan: Optional[StrictStr] = Field(default=None, description="Specify a time duration in milliseconds, seconds, minutes, hours.")
    refresh_token_grant_id_token_lifespan: Optional[StrictStr] = Field(default=None, description="Specify a time duration in milliseconds, seconds, minutes, hours.")
    refresh_token_grant_refresh_token_lifespan: Optional[StrictStr] = Field(default=None, description="Specify a time duration in milliseconds, seconds, minutes, hours.")
    ...
    token_endpoint_auth_method: Optional[StrictStr] = Field(default=None, description="OAuth 2.0 Token Endpoint Authentication Method  Requested Client Authentication method for the Token Endpoint. The options are:  `client_secret_basic`: (default) Send `client_id` and `client_secret` as `application/x-www-form-urlencoded` encoded in the HTTP Authorization header. `client_secret_post`: Send `client_id` and `client_secret` as `application/x-www-form-urlencoded` in the HTTP body. `private_key_jwt`: Use JSON Web Tokens to authenticate the client. `none`: Used for public clients (native apps, mobile apps) which can not have secrets.")
