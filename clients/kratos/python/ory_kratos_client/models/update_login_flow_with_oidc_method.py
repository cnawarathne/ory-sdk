...
class UpdateLoginFlowWithOidcMethod(BaseModel):
    ...
    id_token_nonce: Optional[StrictStr] = Field(default=None, description="IDTokenNonce is the nonce, used when generating the IDToken. If the provider supports nonce validation, the nonce will be validated against this value and required.")
    ...
    traits: Optional[Dict[str, Any]] = Field(default=None, description="The identity traits. This is a placeholder for the registration flow.")
