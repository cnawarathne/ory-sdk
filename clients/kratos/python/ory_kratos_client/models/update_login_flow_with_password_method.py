...
class UpdateLoginFlowWithPasswordMethod(BaseModel):
    ...
    method: StrictStr = Field(description="Method should be set to \"password\" when logging in using the identifier and password strategy.")
    password: StrictStr = Field(description="The user's password.")
    password_identifier: Optional[StrictStr] = Field(default=None, description="Identifier is the email or username of the user trying to log in. This field is deprecated!")
    ...
    __properties: ClassVar[List[str]] = ["csrf_token", "identifier", "method", "password", "password_identifier", "transient_payload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "password_identifier": obj.get("password_identifier"),
