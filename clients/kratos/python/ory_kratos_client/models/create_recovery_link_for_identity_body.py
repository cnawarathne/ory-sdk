...
class CreateRecoveryLinkForIdentityBody(BaseModel):
    ...
    """ # noqa: E501
    expires_in: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Link Expires In  The recovery link will expire after that amount of time has passed. Defaults to the configuration value of `selfservice.methods.code.config.lifespan`.")
    identity_id: StrictStr = Field(description="Identity to Recover  The identity's ID you wish to recover.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["expires_in", "identity_id"]
