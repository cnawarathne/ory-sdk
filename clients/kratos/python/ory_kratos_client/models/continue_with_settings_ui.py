...
class ContinueWithSettingsUi(BaseModel):
    ...
    """ # noqa: E501
    action: StrictStr = Field(description="Action will always be `show_settings_ui` show_settings_ui ContinueWithActionShowSettingsUIString")
    ...
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['show_settings_ui']):
            raise ValueError("must be one of enum values ('show_settings_ui')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flow": ContinueWithSettingsUiFlow.from_dict(obj["flow"]) if obj.get("flow") is not None else None
        })
