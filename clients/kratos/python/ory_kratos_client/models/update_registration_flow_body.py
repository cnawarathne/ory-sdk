...
UPDATEREGISTRATIONFLOWBODY_ONE_OF_SCHEMAS = ["UpdateRegistrationFlowWithCodeMethod", "UpdateRegistrationFlowWithOidcMethod", "UpdateRegistrationFlowWithPasskeyMethod", "UpdateRegistrationFlowWithPasswordMethod", "UpdateRegistrationFlowWithProfileMethod", "UpdateRegistrationFlowWithWebAuthnMethod"]
...
class UpdateRegistrationFlowBody(BaseModel):
    ...
    oneof_schema_6_validator: Optional[UpdateRegistrationFlowWithProfileMethod] = None
    actual_instance: Optional[Union[UpdateRegistrationFlowWithCodeMethod, UpdateRegistrationFlowWithOidcMethod, UpdateRegistrationFlowWithPasskeyMethod, UpdateRegistrationFlowWithPasswordMethod, UpdateRegistrationFlowWithProfileMethod, UpdateRegistrationFlowWithWebAuthnMethod]] = None
    one_of_schemas: Set[str] = { "UpdateRegistrationFlowWithCodeMethod", "UpdateRegistrationFlowWithOidcMethod", "UpdateRegistrationFlowWithPasskeyMethod", "UpdateRegistrationFlowWithPasswordMethod", "UpdateRegistrationFlowWithProfileMethod", "UpdateRegistrationFlowWithWebAuthnMethod" }
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], UpdateRegistrationFlowWithCodeMethod, UpdateRegistrationFlowWithOidcMethod, UpdateRegistrationFlowWithPasskeyMethod, UpdateRegistrationFlowWithPasswordMethod, UpdateRegistrationFlowWithProfileMethod, UpdateRegistrationFlowWithWebAuthnMethod]]:
