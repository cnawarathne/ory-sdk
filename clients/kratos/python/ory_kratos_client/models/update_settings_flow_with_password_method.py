...
class UpdateSettingsFlowWithPasswordMethod(BaseModel):
    ...
    method: StrictStr = Field(description="Method  Should be set to password when trying to update a password.")
    password: StrictStr = Field(description="Password is the updated password")
    ...
    __properties: ClassVar[List[str]] = ["csrf_token", "method", "password", "transient_payload"]
