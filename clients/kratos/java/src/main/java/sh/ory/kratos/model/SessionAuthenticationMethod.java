...
public class SessionAuthenticationMethod {
  ...
  public static final String SERIALIZED_NAME_DEVICE_TRUST_BASED = "device_trust_based";
  @SerializedName(SERIALIZED_NAME_DEVICE_TRUST_BASED)
  private Boolean deviceTrustBased;
  ...
  public SessionAuthenticationMethod deviceTrustBased(Boolean deviceTrustBased) {
    this.deviceTrustBased = deviceTrustBased;
    return this;
  }

  /**
   * DeviceTrustBased indicates that this authentication method was added due to device trust
   * @return deviceTrustBased
   */
  @javax.annotation.Nullable
  public Boolean getDeviceTrustBased() {
    return deviceTrustBased;
  }

  public void setDeviceTrustBased(Boolean deviceTrustBased) {
    this.deviceTrustBased = deviceTrustBased;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aal, sessionAuthenticationMethod.aal) &&
        ...
        Objects.equals(this.deviceTrustBased, sessionAuthenticationMethod.deviceTrustBased) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aal, completedAt, deviceTrustBased, method, organization, provider, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    deviceTrustBased: ").append(toIndentedString(deviceTrustBased)).append("\n");
  ...
  static {
    ...
    openapiFields.add("device_trust_based");
