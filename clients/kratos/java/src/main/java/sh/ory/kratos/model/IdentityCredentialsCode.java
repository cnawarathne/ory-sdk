...
import sh.ory.kratos.model.IdentityCredentialsCodeAddress;
...
public class IdentityCredentialsCode {
  ...
  private List<IdentityCredentialsCodeAddress> addresses = new ArrayList<>();

  public IdentityCredentialsCode() {
  }

  public IdentityCredentialsCode addresses(List<IdentityCredentialsCodeAddress> addresses) {
    this.addresses = addresses;
    return this;
  }

  public IdentityCredentialsCode addAddressesItem(IdentityCredentialsCodeAddress addressesItem) {
  ...
  public List<IdentityCredentialsCodeAddress> getAddresses() {
    return addresses;
  }

  public void setAddresses(List<IdentityCredentialsCodeAddress> addresses) {
    this.addresses = addresses;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addresses, identityCredentialsCode.addresses)&&
      ...
      if (jsonObj.get("addresses") != null && !jsonObj.get("addresses").isJsonNull()) {
        ...
        if (jsonArrayaddresses != null) {
          ...
          for (int i = 0; i < jsonArrayaddresses.size(); i++) {
            IdentityCredentialsCodeAddress.validateJsonElement(jsonArrayaddresses.get(i));
          };
        }
      }
  }
