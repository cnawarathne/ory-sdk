...
class UpdateLoginFlowWithTotpMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('trustDevice', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getTrustDevice()
    {
        return $this->container['trustDevice'];
    }

    /**
     * Sets trustDevice
     *
     * @param bool|null $trustDevice Trust this device
     *
     * @return self
     */
    public function setTrustDevice($trustDevice)
    {
        if (is_null($trustDevice)) {
            throw new \InvalidArgumentException('non-nullable trustDevice cannot be null');
        }
        $this->container['trustDevice'] = $trustDevice;
