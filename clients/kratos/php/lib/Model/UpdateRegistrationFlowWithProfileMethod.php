...
/**
 * UpdateRegistrationFlowWithProfileMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateRegistrationFlowWithProfileMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateRegistrationFlowWithProfileMethod';
    ...
    public const SCREEN_CREDENTIAL_SELECTION = 'credential-selection';
    public const SCREEN_PREVIOUS = 'previous';
     ...
     * @return string[]
     */
    public function getScreenAllowableValues()
    {
        return [
            self::SCREEN_CREDENTIAL_SELECTION,
            self::SCREEN_PREVIOUS,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getScreenAllowableValues();
        if (!is_null($this->container['screen']) && !in_array($this->container['screen'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'screen', must be one of '%s'",
     ...
     * Sets screen
     *
     * @param string|null $screen Screen requests navigation to a previous screen.  This must be set to credential-selection to go back to the credential selection screen. credential-selection RegistrationScreenCredentialSelection nolint:gosec // not a credential previous RegistrationScreenPrevious
     *
     * @return self
     */
    public function setScreen($screen)
    {
        ...
        $allowedValues = $this->getScreenAllowableValues();
        if (!in_array($screen, $allowedValues, true)) {
