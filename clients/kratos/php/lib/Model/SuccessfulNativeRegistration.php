...
/**
 * SuccessfulNativeRegistration Class Doc Comment
 *
 * @category Class
 ...
 */
class SuccessfulNativeRegistration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'successfulNativeRegistration';
    ...
    protected static $openAPITypes = [
        'continueWith' => '\Ory\Kratos\Client\Model\ContinueWith[]',
    ...
    */
     ...
     * Gets continueWith
     *
     * @return \Ory\Kratos\Client\Model\ContinueWith[]|null
     */
     ...
     * Sets continueWith
     *
     * @param \Ory\Kratos\Client\Model\ContinueWith[]|null $continueWith Contains a list of actions, that could follow this flow  It can, for example, this will contain a reference to the verification flow, created as part of the user's registration or the token of the session.
     *
     * @return self
     */
