...
class SettingsFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets continueWith
     *
     * @param \Ory\Kratos\Client\Model\ContinueWith[]|null $continueWith Contains a list of actions, that could follow this flow  It can, for example, contain a reference to the verification flow, created as part of the user's registration.
     *
     * @return self
     */
