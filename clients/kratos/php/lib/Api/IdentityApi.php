...
class IdentityApi
{
     ...
     *
     * @param  \Ory\Kratos\Client\Model\PatchIdentitiesBody|null $patchIdentitiesBody patchIdentitiesBody (optional)
     ...
     * Create multiple identities
     *
     * @param  \Ory\Kratos\Client\Model\PatchIdentitiesBody|null $patchIdentitiesBody (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['batchPatchIdentities'] to see the possible values for this operation
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Kratos\Client\Model\BatchPatchIdentitiesResponse' === '\SplFileObject') {
                        ...
                        if ('\Ory\Kratos\Client\Model\BatchPatchIdentitiesResponse' !== 'string') {
                            try {
     ...
     * Create an Identity
     *
     * @param  \Ory\Kratos\Client\Model\CreateIdentityBody|null $createIdentityBody createIdentityBody (optional)
     ...
     * Create an Identity
     *
     * @param  \Ory\Kratos\Client\Model\CreateIdentityBody|null $createIdentityBody (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createIdentity'] to see the possible values for this operation
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
            ...
            switch($statusCode) {
                case 201:
                    if ('\Ory\Kratos\Client\Model\Identity' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Ory\Kratos\Client\Model\Identity' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
     ...
     *
     * @param  \Ory\Kratos\Client\Model\CreateRecoveryCodeForIdentityBody|null $createRecoveryCodeForIdentityBody createRecoveryCodeForIdentityBody (optional)
     ...
     * Create a Recovery Code
     *
     * @param  \Ory\Kratos\Client\Model\CreateRecoveryCodeForIdentityBody|null $createRecoveryCodeForIdentityBody (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createRecoveryCodeForIdentity'] to see the possible values for this operation
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
            ...
            switch($statusCode) {
                case 201:
                    if ('\Ory\Kratos\Client\Model\RecoveryCodeForIdentity' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Ory\Kratos\Client\Model\RecoveryCodeForIdentity' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
     ...
     * @param  \Ory\Kratos\Client\Model\CreateRecoveryLinkForIdentityBody|null $createRecoveryLinkForIdentityBody createRecoveryLinkForIdentityBody (optional)
     ...
     * @param  \Ory\Kratos\Client\Model\CreateRecoveryLinkForIdentityBody|null $createRecoveryLinkForIdentityBody (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createRecoveryLinkForIdentity'] to see the possible values for this operation
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Kratos\Client\Model\RecoveryLinkForIdentity' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Ory\Kratos\Client\Model\RecoveryLinkForIdentity' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    /**
     * Operation listIdentityDevices
     *
     * List an Identity&#39;s trusted devices
     *
     * @param  string $id ID is the identity&#39;s ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listIdentityDevices'] to see the possible values for this operation
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SessionDevice[]|\Ory\Kratos\Client\Model\ErrorGeneric|\Ory\Kratos\Client\Model\ErrorGeneric|\Ory\Kratos\Client\Model\ErrorGeneric
     */
    public function listIdentityDevices($id, string $contentType = self::contentTypes['listIdentityDevices'][0])
    {
        list($response) = $this->listIdentityDevicesWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation listIdentityDevicesWithHttpInfo
     *
     * List an Identity&#39;s trusted devices
     *
     * @param  string $id ID is the identity&#39;s ID. (required)
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\SessionDevice[]|\Ory\Kratos\Client\Model\ErrorGeneric|\Ory\Kratos\Client\Model\ErrorGeneric|\Ory\Kratos\Client\Model\ErrorGeneric, HTTP status code, HTTP response headers (array of strings)
     */
    public function listIdentityDevicesWithHttpInfo($id, string $contentType = self::contentTypes['listIdentityDevices'][0])
    {
        $request = $this->listIdentityDevicesRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Kratos\Client\Model\SessionDevice[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ory\Kratos\Client\Model\SessionDevice[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ory\Kratos\Client\Model\SessionDevice[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Ory\Kratos\Client\Model\SessionDevice[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ory\Kratos\Client\Model\SessionDevice[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation listIdentityDevicesAsync
     *
     * List an Identity&#39;s trusted devices
     *
     * @param  string $id ID is the identity&#39;s ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentityDevicesAsync($id, string $contentType = self::contentTypes['listIdentityDevices'][0])
    {
        return $this->listIdentityDevicesAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listIdentityDevicesAsyncWithHttpInfo
     *
     * List an Identity&#39;s trusted devices
     *
     * @param  string $id ID is the identity&#39;s ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listIdentityDevicesAsyncWithHttpInfo($id, string $contentType = self::contentTypes['listIdentityDevices'][0])
    {
        $returnType = '\Ory\Kratos\Client\Model\SessionDevice[]';
        $request = $this->listIdentityDevicesRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'listIdentityDevices'
     *
     * @param  string $id ID is the identity&#39;s ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listIdentityDevices'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listIdentityDevicesRequest($id, string $contentType = self::contentTypes['listIdentityDevices'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling listIdentityDevices'
            );
        }


        $resourcePath = '/admin/identities/{id}/devices';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ory\Kratos\Client\Model\IdentitySchemaContainer[]' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Ory\Kratos\Client\Model\IdentitySchemaContainer[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
     ...
     * @param  \Ory\Kratos\Client\Model\JsonPatch[]|null $jsonPatch jsonPatch (optional)
     ...
     *
     * @param  string $id ID must be set to the ID of identity you want to update (required)
     * @param  \Ory\Kratos\Client\Model\JsonPatch[]|null $jsonPatch (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchIdentity'] to see the possible values for this operation
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation patchIdentityDevices
     *
     * Patch an Identity&#39;s devices
     *
     * @param  string $id ID is the session&#39;s ID. (required)
     * @param  string $deviceId DeviceID is the Identity&#39;s Device&#39;s ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchIdentityDevices'] to see the possible values for this operation
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Ory\Kratos\Client\Model\SessionDevice[]|\Ory\Kratos\Client\Model\ErrorGeneric|\Ory\Kratos\Client\Model\ErrorGeneric|\Ory\Kratos\Client\Model\ErrorGeneric|\Ory\Kratos\Client\Model\ErrorGeneric
     */
    public function patchIdentityDevices($id, $deviceId, string $contentType = self::contentTypes['patchIdentityDevices'][0])
    {
        list($response) = $this->patchIdentityDevicesWithHttpInfo($id, $deviceId, $contentType);
        return $response;
    }

    /**
     * Operation patchIdentityDevicesWithHttpInfo
     *
     * Patch an Identity&#39;s devices
     *
     * @param  string $id ID is the session&#39;s ID. (required)
     ...
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Ory\Kratos\Client\Model\SessionDevice[]|\Ory\Kratos\Client\Model\ErrorGeneric|\Ory\Kratos\Client\Model\ErrorGeneric|\Ory\Kratos\Client\Model\ErrorGeneric|\Ory\Kratos\Client\Model\ErrorGeneric, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchIdentityDevicesWithHttpInfo($id, $deviceId, string $contentType = self::contentTypes['patchIdentityDevices'][0])
    {
        $request = $this->patchIdentityDevicesRequest($id, $deviceId, $contentType);
    ...
    /**
     * Operation patchIdentityDevicesAsync
     *
     * Patch an Identity&#39;s devices
     *
     * @param  string $id ID is the session&#39;s ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchIdentityDevicesAsync($id, $deviceId, string $contentType = self::contentTypes['patchIdentityDevices'][0])
    {
        return $this->patchIdentityDevicesAsyncWithHttpInfo($id, $deviceId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation patchIdentityDevicesAsyncWithHttpInfo
     *
     * Patch an Identity&#39;s devices
     *
     * @param  string $id ID is the session&#39;s ID. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function patchIdentityDevicesAsyncWithHttpInfo($id, $deviceId, string $contentType = self::contentTypes['patchIdentityDevices'][0])
    {
        $returnType = '\Ory\Kratos\Client\Model\SessionDevice[]';
        $request = $this->patchIdentityDevicesRequest($id, $deviceId, $contentType);
    ...
    /**
     * Create request for operation 'patchIdentityDevices'
     *
     * @param  string $id ID is the session&#39;s ID. (required)
     * @param  string $deviceId DeviceID is the Identity&#39;s Device&#39;s ID. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchIdentityDevices'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function patchIdentityDevicesRequest($id, $deviceId, string $contentType = self::contentTypes['patchIdentityDevices'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling patchIdentityDevices'
            );
        }
        ...
        if ($deviceId === null || (is_array($deviceId) && count($deviceId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $deviceId when calling patchIdentityDevices'
            );
        }


        $resourcePath = '/admin/identities/{id}/devices/{device_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $id ID must be set to the ID of identity you want to update (required)
     * @param  \Ory\Kratos\Client\Model\UpdateIdentityBody|null $updateIdentityBody updateIdentityBody (optional)
     ...
     *
     * @param  string $id ID must be set to the ID of identity you want to update (required)
     * @param  \Ory\Kratos\Client\Model\UpdateIdentityBody|null $updateIdentityBody (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateIdentity'] to see the possible values for this operation
     *
     * @throws \Ory\Kratos\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
