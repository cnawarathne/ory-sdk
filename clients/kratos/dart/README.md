...
```yaml
dependencies:
  ory_kratos_client: 1.4.0-alpha.0
```
...
[*IdentityApi*](doc/IdentityApi.md) | [**listIdentityDevices**](doc/IdentityApi.md#listidentitydevices) | **GET** /admin/identities/{id}/devices | List an Identity&#39;s trusted devices
...
[*IdentityApi*](doc/IdentityApi.md) | [**patchIdentityDevices**](doc/IdentityApi.md#patchidentitydevices) | **PATCH** /admin/identities/{id}/devices/{device_id} | Patch an Identity&#39;s devices
...
## Documentation For Models
 ...
 - [UiNodeDivisionAttributes](doc/UiNodeDivisionAttributes.md)
