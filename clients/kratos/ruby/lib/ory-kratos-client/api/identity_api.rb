...
module OryKratosClient
  class IdentityApi
    ...
    # @param id [String] ID is the identity&#39;s ID.
    # @param [Hash] opts the optional parameters
    # @return [Array<SessionDevice>]
    def list_identity_devices(id, opts = {})
      data, _status_code, _headers = list_identity_devices_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] ID is the identity&#39;s ID.
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<SessionDevice>, Integer, Hash)>] Array<SessionDevice> data, response status code and response headers
    def list_identity_devices_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IdentityApi.list_identity_devices ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IdentityApi.list_identity_devices"
      end
      # resource path
      local_var_path = '/admin/identities/{id}/devices'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<SessionDevice>'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['oryAccessToken']

      new_options = opts.merge(
        :operation => :"IdentityApi.list_identity_devices",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IdentityApi#list_identity_devices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] ID is the session&#39;s ID.
    # @param device_id [String] DeviceID is the Identity&#39;s Device&#39;s ID.
    # @param [Hash] opts the optional parameters
    # @return [Array<SessionDevice>]
    def patch_identity_devices(id, device_id, opts = {})
      data, _status_code, _headers = patch_identity_devices_with_http_info(id, device_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<SessionDevice>, Integer, Hash)>] Array<SessionDevice> data, response status code and response headers
    def patch_identity_devices_with_http_info(id, device_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IdentityApi.patch_identity_devices ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling IdentityApi.patch_identity_devices"
      end
      # verify the required parameter 'device_id' is set
      if @api_client.config.client_side_validation && device_id.nil?
        fail ArgumentError, "Missing the required parameter 'device_id' when calling IdentityApi.patch_identity_devices"
      end
      # resource path
      local_var_path = '/admin/identities/{id}/devices/{device_id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s)).sub('{' + 'device_id' + '}', CGI.escape(device_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"IdentityApi.patch_identity_devices",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IdentityApi#patch_identity_devices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
