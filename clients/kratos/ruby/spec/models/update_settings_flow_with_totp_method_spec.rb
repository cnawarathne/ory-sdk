...
# Unit tests for OryKratosClient::UpdateSettingsFlowWithTotpMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OryKratosClient::UpdateSettingsFlowWithTotpMethod do
  let(:instance) { OryKratosClient::UpdateSettingsFlowWithTotpMethod.new }
  ...
  describe 'test an instance of UpdateSettingsFlowWithTotpMethod' do
    it 'should create an instance of UpdateSettingsFlowWithTotpMethod' do
      ...
      #expect(instance).to be_instance_of(OryKratosClient::UpdateSettingsFlowWithTotpMethod)
    end
  end
