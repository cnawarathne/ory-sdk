...
# Unit tests for OryKratosClient::IdentityApi
...
describe 'IdentityApi' do
  ...
  describe 'test an instance of IdentityApi' do
    it 'should create an instance of IdentityApi' do
      expect(@api_instance).to be_instance_of(OryKratosClient::IdentityApi)
    end
  end
  ...
  # unit tests for list_identity_devices
  ...
  describe 'list_identity_devices test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for patch_identity_devices
  ...
  # @param id ID is the session&#39;s ID.
  # @param device_id DeviceID is the Identity&#39;s Device&#39;s ID.
  # @param [Hash] opts the optional parameters
  # @return [Array<SessionDevice>]
  describe 'patch_identity_devices test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
