...
namespace Ory.Kratos.Client.Model
{
    ...
    public partial class KratosUpdateLoginFlowWithTotpMethod : IValidatableObject
    {
        ...
        [JsonConstructor]
        public KratosUpdateLoginFlowWithTotpMethod(string method, string totpCode, Option<string?> csrfToken = default, Option<Object?> transientPayload = default, Option<bool?> trustDevice = default)
        {
            Method = method;
            TotpCode = totpCode;
    ...
    public class KratosUpdateLoginFlowWithTotpMethodJsonConverter : JsonConverter<KratosUpdateLoginFlowWithTotpMethod>
    {
        ...
        public override KratosUpdateLoginFlowWithTotpMethod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (trustDevice.IsSet && trustDevice.Value == null)
                throw new ArgumentNullException(nameof(trustDevice), "Property is not nullable for class KratosUpdateLoginFlowWithTotpMethod.");

            return new KratosUpdateLoginFlowWithTotpMethod(method.Value!, totpCode.Value!, csrfToken, transientPayload, trustDevice);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, KratosUpdateLoginFlowWithTotpMethod kratosUpdateLoginFlowWithTotpMethod, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (kratosUpdateLoginFlowWithTotpMethod.TrustDeviceOption.IsSet)
                writer.WriteBoolean("trust_device", kratosUpdateLoginFlowWithTotpMethod.TrustDeviceOption.Value!.Value);
        }
    }
}
