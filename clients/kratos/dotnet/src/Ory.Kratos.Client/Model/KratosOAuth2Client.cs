                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "frontchannel_logout_session_required":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                frontchannelLogoutSessionRequired = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        ...
                        case "skip_consent":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                skipConsent = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "skip_logout_consent":
                            if (utf8JsonReader.TokenType != JsonTokenType.Null)
                                skipLogoutConsent = new Option<bool?>(utf8JsonReader.GetBoolean());
                            break;
                        case "subject_type":
