...
namespace Ory.Kratos.Client.Api
{
    ...
    public interface IFrontendApi : IApi
    {
        ...
        Task<ICreateNativeRegistrationFlowApiResponse> CreateNativeRegistrationFlowAsync(Option<bool> returnSessionTokenExchangeCode = default, Option<string> returnTo = default, Option<string> organization = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateNativeRegistrationFlowApiResponse"/>?&gt;</returns>
        Task<ICreateNativeRegistrationFlowApiResponse?> CreateNativeRegistrationFlowOrDefaultAsync(Option<bool> returnSessionTokenExchangeCode = default, Option<string> returnTo = default, Option<string> organization = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    public sealed partial class FrontendApi : IFrontendApi
    {
        ...
        /// <param name="organization"></param>
        /// <param name="via"></param>
        private void OnErrorCreateBrowserLoginFlowDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<bool> refresh, Option<string> aal, Option<string> returnTo, Option<string> cookie, Option<string> loginChallenge, Option<string> organization, Option<string> via)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorCreateBrowserLoginFlow(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, refresh, aal, returnTo, cookie, loginChallenge, organization, via);
        ...
        /// <param name="afterVerificationReturnTo"></param>
        /// <param name="organization"></param>
        private void OnErrorCreateBrowserRegistrationFlowDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<string> returnTo, Option<string> loginChallenge, Option<string> afterVerificationReturnTo, Option<string> organization)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorCreateBrowserRegistrationFlow(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, returnTo, loginChallenge, afterVerificationReturnTo, organization);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="afterVerificationReturnTo"></param>
        /// <param name="organization"></param>
        partial void OnErrorCreateBrowserRegistrationFlow(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<string> returnTo, Option<string> loginChallenge, Option<string> afterVerificationReturnTo, Option<string> organization);
        ...
        public async Task<ICreateFedcmFlowApiResponse> CreateFedcmFlowAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/self-service/fed-cm/parameters";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        CreateFedcmFlowApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/self-service/fed-cm/parameters", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        partial void FormatCreateNativeLoginFlow(ref Option<bool> refresh, ref Option<string> aal, ref Option<string> xSessionToken, ref Option<bool> returnSessionTokenExchangeCode, ref Option<string> returnTo, ref Option<string> organization, ref Option<string> via);
        ...
        /// <param name="via"></param>
        /// <returns></returns>
        private void ValidateCreateNativeLoginFlow(Option<string> aal, Option<string> xSessionToken, Option<string> returnTo, Option<string> organization, Option<string> via)
        {
            if (aal.IsSet && aal.Value == null)
                throw new ArgumentNullException(nameof(aal));
        ...
        /// <param name="organization"></param>
        /// <param name="via"></param>
        private void AfterCreateNativeLoginFlowDefaultImplementation(ICreateNativeLoginFlowApiResponse apiResponseLocalVar, Option<bool> refresh, Option<string> aal, Option<string> xSessionToken, Option<bool> returnSessionTokenExchangeCode, Option<string> returnTo, Option<string> organization, Option<string> via)
        {
            bool suppressDefaultLog = false;
            AfterCreateNativeLoginFlow(ref suppressDefaultLog, apiResponseLocalVar, refresh, aal, xSessionToken, returnSessionTokenExchangeCode, returnTo, organization, via);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="organization"></param>
        /// <param name="via"></param>
        partial void AfterCreateNativeLoginFlow(ref bool suppressDefaultLog, ICreateNativeLoginFlowApiResponse apiResponseLocalVar, Option<bool> refresh, Option<string> aal, Option<string> xSessionToken, Option<bool> returnSessionTokenExchangeCode, Option<string> returnTo, Option<string> organization, Option<string> via);
        ...
        public async Task<ICreateNativeLoginFlowApiResponse?> CreateNativeLoginFlowOrDefaultAsync(Option<bool> refresh = default, Option<string> aal = default, Option<string> xSessionToken = default, Option<bool> returnSessionTokenExchangeCode = default, Option<string> returnTo = default, Option<string> organization = default, Option<string> via = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await CreateNativeLoginFlowAsync(refresh, aal, xSessionToken, returnSessionTokenExchangeCode, returnTo, organization, via, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<ICreateNativeLoginFlowApiResponse> CreateNativeLoginFlowAsync(Option<bool> refresh = default, Option<string> aal = default, Option<string> xSessionToken = default, Option<bool> returnSessionTokenExchangeCode = default, Option<string> returnTo = default, Option<string> organization = default, Option<string> via = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidateCreateNativeLoginFlow(aal, xSessionToken, returnTo, organization, via);

                FormatCreateNativeLoginFlow(ref refresh, ref aal, ref xSessionToken, ref returnSessionTokenExchangeCode, ref returnTo, ref organization, ref via);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterCreateNativeLoginFlowDefaultImplementation(apiResponseLocalVar, refresh, aal, xSessionToken, returnSessionTokenExchangeCode, returnTo, organization, via);
            ...
            {
                OnErrorCreateNativeLoginFlowDefaultImplementation(e, "/self-service/login/api", uriBuilderLocalVar.Path, refresh, aal, xSessionToken, returnSessionTokenExchangeCode, returnTo, organization, via);
        ...
        partial void FormatCreateNativeRegistrationFlow(ref Option<bool> returnSessionTokenExchangeCode, ref Option<string> returnTo, ref Option<string> organization);
        ...
        /// <param name="organization"></param>
        /// <returns></returns>
        private void ValidateCreateNativeRegistrationFlow(Option<string> returnTo, Option<string> organization)
        {
            if (returnTo.IsSet && returnTo.Value == null)
                throw new ArgumentNullException(nameof(returnTo));
        ...
        /// <param name="returnTo"></param>
        /// <param name="organization"></param>
        private void AfterCreateNativeRegistrationFlowDefaultImplementation(ICreateNativeRegistrationFlowApiResponse apiResponseLocalVar, Option<bool> returnSessionTokenExchangeCode, Option<string> returnTo, Option<string> organization)
        {
            bool suppressDefaultLog = false;
            AfterCreateNativeRegistrationFlow(ref suppressDefaultLog, apiResponseLocalVar, returnSessionTokenExchangeCode, returnTo, organization);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {3}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="returnTo"></param>
        /// <param name="organization"></param>
        partial void AfterCreateNativeRegistrationFlow(ref bool suppressDefaultLog, ICreateNativeRegistrationFlowApiResponse apiResponseLocalVar, Option<bool> returnSessionTokenExchangeCode, Option<string> returnTo, Option<string> organization);
        ...
        /// <param name="returnTo"></param>
        /// <param name="organization"></param>
        private void OnErrorCreateNativeRegistrationFlowDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<bool> returnSessionTokenExchangeCode, Option<string> returnTo, Option<string> organization)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorCreateNativeRegistrationFlow(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, returnSessionTokenExchangeCode, returnTo, organization);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="returnTo"></param>
        /// <param name="organization"></param>
        partial void OnErrorCreateNativeRegistrationFlow(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<bool> returnSessionTokenExchangeCode, Option<string> returnTo, Option<string> organization);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateNativeRegistrationFlowApiResponse"/>&gt;</returns>
        public async Task<ICreateNativeRegistrationFlowApiResponse?> CreateNativeRegistrationFlowOrDefaultAsync(Option<bool> returnSessionTokenExchangeCode = default, Option<string> returnTo = default, Option<string> organization = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await CreateNativeRegistrationFlowAsync(returnSessionTokenExchangeCode, returnTo, organization, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateNativeRegistrationFlowApiResponse"/>&gt;</returns>
        public async Task<ICreateNativeRegistrationFlowApiResponse> CreateNativeRegistrationFlowAsync(Option<bool> returnSessionTokenExchangeCode = default, Option<string> returnTo = default, Option<string> organization = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateCreateNativeRegistrationFlow(returnTo, organization);

                FormatCreateNativeRegistrationFlow(ref returnSessionTokenExchangeCode, ref returnTo, ref organization);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterCreateNativeRegistrationFlowDefaultImplementation(apiResponseLocalVar, returnSessionTokenExchangeCode, returnTo, organization);
            ...
            {
                OnErrorCreateNativeRegistrationFlowDefaultImplementation(e, "/self-service/registration/api", uriBuilderLocalVar.Path, returnSessionTokenExchangeCode, returnTo, organization);
        ...
        public async Task<IUpdateFedcmFlowApiResponse> UpdateFedcmFlowAsync(KratosUpdateFedcmFlowBody kratosUpdateFedcmFlowBody, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Port = HttpClient.BaseAddress.Port;
                    uriBuilderLocalVar.Scheme = HttpClient.BaseAddress.Scheme;
                    uriBuilderLocalVar.Path = ClientUtils.CONTEXT_PATH + "/self-service/fed-cm/token";
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        UpdateFedcmFlowApiResponse apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/self-service/fed-cm/token", requestedAtLocalVar, _jsonSerializerOptions);
